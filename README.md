<div align="center">
  ...
  ![Version](https://img.shields.io/badge/version-8.218.0-blue)
...
```
Nitrite_8.218.0_x64-setup.exe
```

Ou la release portable tout-en-un (`Nitrite_v8.218.0_full.exe`) : app + logiciels portables + drivers + scripts Windows, sans installation.
